...
function Icon(props) {
    ...
    switch (type) {
        ...
        case 'bagFavIcon':
            return (
                <svg xmlns="http://www.w3.org/2000/svg" height="40" width="40" fill="#373F41">
        ...
        case 'profilePersonalData':
            return (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" width="35" height="35">
                    <path
                        d="M2.406 2A.5.5 0 0 0 2 2.5v27a.5.5 0 0 0 .5.5h27a.5.5 0 0 0 .5-.5v-27a.5.5 0 0 0-.5-.5h-27a.5.5 0 0 0-.094 0zM3 3h26v3H3V3zm1.406 1A.5.5 0 0 0 4 4.5a.5.5 0 0 0 .5.5.5.5 0 0 0 .5-.5.5.5 0 0 0-.5-.5.5.5 0 0 0-.094 0zm2 0A.5.5 0 0 0 6 4.5a.5.5 0 0 0 .5.5.5.5 0 0 0 .5-.5.5.5 0 0 0-.5-.5.5.5 0 0 0-.094 0zm2 0A.5.5 0 0 0 8 4.5a.5.5 0 0 0 .5.5.5.5 0 0 0 .5-.5.5.5 0 0 0-.5-.5.5.5 0 0 0-.094 0zM3 7h26v22H3V7zm1.844 1.5A.5.5 0 0 0 4.5 9v7a.5.5 0 0 0 .5.5h7a.5.5 0 0 0 .5-.5V9a.5.5 0 0 0-.5-.5H5a.5.5 0 0 0-.156 0zM14 8.5v1h5v-1h-5zm-8.5 1h6v6h-6v-6zm8.5 1v1h13v-1H14zm0 2v1h11v-1H14zm0 2v1h11v-1H14zm0 2v1h11v-1H14zm-9 1v1h7v-1H5zm9 1v1h4v-1h-4zm-9 1v1h4v-1H5zm5.844 4c-.734 0-1.344.577-1.344 1.313v.843c0 .736.61 1.344 1.344 1.344h2.562c.734 0 1.344-.608 1.344-1.344v-.843c0-.736-.61-1.313-1.344-1.313h-2.562zm7 0c-.734 0-1.344.577-1.344 1.313v.843c0 .736.61 1.344 1.344 1.344h2.562c.734 0 1.344-.608 1.344-1.344v-.843c0-.736-.61-1.313-1.344-1.313h-2.562zm-7 1h2.562c.208 0 .344.125.344.313v.843a.334.334 0 0 1-.344.344h-2.562a.334.334 0 0 1-.344-.344v-.843c0-.188.136-.313.344-.313zm7 0h2.562c.208 0 .344.125.344.313v.843a.334.334 0 0 1-.344.344h-2.562a.334.334 0 0 1-.344-.344v-.843c0-.188.136-.313.344-.313z"
                        color="#000"
                        overflow="visible"
